...
class TextHookInterop
{
	...
	[DllImport("ithwrapper.dll")]
	public static extern Int32 TextHookOnCreateThread(
		OnCreateThreadFunc callback);

	public delegate Int32 OnRemoveThreadFunc(Int32 thread_id);

	[DllImport("ithwrapper.dll")]
	public static extern Int32 TextHookOnRemoveThread(
		OnRemoveThreadFunc callback);

	public delegate Int32 OnInputFunc(
		Int32 thread_id,
		IntPtr data,
		Int32 len,
		Int32 is_newline);
	...
	[DllImport("ithwrapper.dll")]
	public static extern Int32 TextHookAddHook(
		ref HookParam p,
		[MarshalAs(UnmanagedType.LPWStr)] string name);
