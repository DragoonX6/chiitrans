...
static class FormUtil
{
	...
	internal static void fixFormPosition(
		Form form,
		IntPtr targetWindow = default(IntPtr))
	{
		if(getFormData(form).initializeCompleted
		   && form.Visible
		   && form.WindowState != FormWindowState.Minimized)
		{
			Rectangle bounds = form.DesktopBounds;
