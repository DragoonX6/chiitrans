...
abstract class ParseResult
{
	...
	internal static ParseResult unparsed(string p) => new UnparsedParseResult(p);
	...
	public abstract ParseResultType type
	{
		get;
	}
	...
	public string asJsonFull() => Utils.toJson(serializeFull());
